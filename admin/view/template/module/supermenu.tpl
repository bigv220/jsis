...
<?php if ($success) { ?>
  ...
  <div class="box">
	...
	<?php $this->load->model('tool/image'); ?>
	  ...
	  <tr>
	  <td style="border: 5px solid #eee; padding: 5px; background: #06f; color: #fff; font-weight: bold; font-size: 14px; width: 300px;">
	  Make the supermenu responsive? <br>
	  <span style="font-size: 11px; font-weight: normal"> Only select yes if you have a responsive theme</span>
	  </td>
