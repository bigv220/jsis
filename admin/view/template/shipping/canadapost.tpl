      ...
      <div id="tab_general" class="page">
        ...
        <td><select name="canadapost_language">
          ...
          <tr>
           ...
           <tr>
            <td style="vertical-align: middle;" colspan="2"><strong><?php echo '<a href="'.$entry_link_sellonline.'" target="_blank">'.$entry_sellonline.'</a>'; ?></strong></td>
          </tr>
          <tr>
            <td style="vertical-align: middle;"><?php echo $entry_version_status ?></td>
            <td style="vertical-align: middle;">
			<strong>You are using version : 1.7.1</strong>
			<br />
			<img src="view/image/CanadaPostShippingModule.png" border="0" alt="Canada Post Shipping"></a></td>
          </tr>
          <tr>
            <td><?php echo $entry_author; ?></td>
            <td><strong>Version 1.2 to 1.7 </strong><br />
            ...
            <strong>Version 1.0 to 1.1</strong><br />
			Jason Mitchell<br />
          ...
          <tr>
            <td height="100%"><?php echo $entry_contributor; ?></td>
			<td><br />
			Kevin Davidson<br />
			Contribution: Fixed weight issue; Multiple items send the rates through the roof.<br /> 
			Website:<a href="http://www.kdmp.ca" target="_blank">Hosting, Design &amp; SEO Services. AVG Authorized Reseller</a><br />
			<img src="view/image/KevinDavidson.jpg"><br /><br />
			</td></tr>
			
			<tr>
			<td height="100%"><?php echo $entry_contributor; ?></td>
			<td><br />
			Tweaked by fmaz008, with help from Qphoria <br />
			Qphoria: OpenCart Global Moderator<br />
			Contribution: Shiping methods and &quot;Undefined index: code&quot; problem, in 1.5.x, &quot;id&quot; was changed to &quot;code&quot; in the returning data array.<br />
            Website: <a href="http://opencartguru.com/ target="_blank"">Open Cart Guru</a><br />
			<img src="view/image/ocglogosig.png"><br /><br />
			</td></tr>
			...
			<td><br />
			adamata<br />
			Contribution: Formatted the totals to two decimal places.<br /><br />
			</td></tr>
			...
			<td><br />	
			Stinn<br />
			Contribution: Added code to actually add the handling fee.<br /><br />
			</td></tr>
			...
			<td><br />	
			SuperJuice<br />
			Contribution: Canada Post Module modeled after AusPost Module for OpenCart 1.4.5.<br />
			Website:<a href="http://www.pixeldrift.net/opencart/" target="_blank">pixeldrift</a><br />
			and <a href="http://addons.oscommerce.com/info/391" target="_blank">Canada Post Shipping Module</a> 
			for osCommerce by: Kelvin Zhang<br /><br />
			</td></tr>
