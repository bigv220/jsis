...
class ControllerModulesupermenu extends Controller {
	protected function index($setting) {
		...
		if ($this->config->get('supermenu_supermenuisresponsive')) {
		
		 $this->data['supermenuisresponsive'] = $this->config->get('supermenu_supermenuisresponsive');
		 
		} else {

		 $this->data['supermenuisresponsive'] = false;
		 
		}
				 $this->data['supermenuisresponsive'] = true;
		if ($items) {
